...
<head>
  ...
  <title>20050974017 | BAGA ARHINZA</title>
...
<main class="container p-3">
      ...
      <table class="table table-striped table-borderless">
        ...
        <tbody class="text-center">
          ...
          do {
            ...
            if (
              ($arrMahasiswa[$index - 1]['ipk'] > 3.10 && $arrMahasiswa[$index - 1]['ipk'] < 3.50) &&
  ...
  <section id="soal-2" class="mb-4">
    ...
    function sortDataNama($index = 0, $max, array $array)
    {
      ...
      do {
        ...
        if (
          ($array[$index - 1]['ipk'] > 3.10 && $array[$index - 1]['ipk'] < 3.50) &&
  ...
  <section id="soal-3">
    ...
    $cari = infoDiriMahasiswa($arrMahasiswa, 'nrp', '20050974017');
